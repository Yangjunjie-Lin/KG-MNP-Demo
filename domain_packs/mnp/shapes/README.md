...
| Eligibility instance | `eligibility` | [`../fixtures/eligibility-use-case/shapes/eligibility-instance-shapes.ttl`](../fixtures/eligibility-use-case/shapes/eligibility-instance-shapes.ttl) | Legacy eligibility use-case strictness (case completeness, assessment evidence/rules/decision, blocking provenance via `hasBlockingReason`) |
