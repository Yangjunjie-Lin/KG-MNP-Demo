...
export default defineConfig({testDir:'tests',testMatch:'*.e2e.ts',timeout:600000,workers:1,retries:0,
  ...
  use:{baseURL:process.env.KG_MNP_BROWSER_URL,viewport:{width:1440,height:900},actionTimeout:20000,navigationTimeout:30000,serviceWorkers:'block',trace:'off',video:'off',screenshot:'off'}});
