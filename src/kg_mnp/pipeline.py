...
``kg_mnp.application.AssessmentService``. This is a downstream example,
...
from kg_mnp.application.assessment_service import (
    AssessmentService,
...
from kg_mnp.trace_graph import render_subgraph_html

# Re-export for existing imports (tests / showcase).
__all__ = ["build_parser", "main", "merge_reference_graph", "run_pipeline"]
