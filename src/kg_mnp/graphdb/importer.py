...
from .client import GraphDBClient, GraphDBClientError
from .identifiers import repository_id_for_publication, validate_repository_id
...
def import_package(client: GraphDBClient, package_directory: Path, *, cleanup_failed_generated_repository: bool = False) -> dict[str, Any]:
    ...
    except Exception:  # transactional cleanup must precede re-raise
