...
def init_registry(workspace: Path|str, *, registry_name="local", project_id="project", accepted_ontology_iris=(), accepted_package_names=(), created_by="operator"):
    ...
    for d in ("events","state","objects/sha256","records/packages","records/feedback","records/changes","records/change-evaluations","records/diffs","records/impacts","records/regressions","records/release-candidates","records/release-reviews","records/releases","records/consumers","records/environments","records/activation-proposals","records/activation-reviews","records/activation-receipts","indexes","packages"):
