...
from zhigou_toolchain.application.serializers import json_safe
from zhigou_toolchain.evaluator import materialize_assessment
from zhigou_toolchain.inference import apply_owlrl
from zhigou_toolchain.loader import load_case_graph
from zhigou_toolchain.namespaces import CASE_FILES
from zhigou_toolchain.paths import domain_pack_path
from zhigou_toolchain.validator import validate_graph


def competency_root() -> Path:
    return domain_pack_path("mnp") / "competency_questions"
