...
from zhigou_toolchain.application.contracts import (
    SCHEMA_VERSION,
...
from zhigou_toolchain.application.serializers import (
    deep_merge,
    json_safe,
    sort_stable,
    to_iso_utc,
)
from zhigou_toolchain.evaluator import evaluate_case
from zhigou_toolchain.inference import apply_owlrl
from zhigou_toolchain.input_adapter import (
    InputValidationError,
    NormalizedCaseInput,
    normalize_case_input,
)
from zhigou_toolchain.loader import merge_reference_graph
from zhigou_toolchain.rdf_builder import build_case_graph
from zhigou_toolchain.rule_engine import RuleConfigurationError
from zhigou_toolchain.trace_graph import (
    TraceSubgraphIntegrityError,
    build_assessment_subgraph,
)
from zhigou_toolchain.validator import validate_graph
...
def evaluate_normalized_case(
    ...
    *,
    ...
    if include_process:
        try:
            from zhigou_toolchain.application.process_service import (
...
class AssessmentService:
    ...
    def run_what_if(
        ...
        from zhigou_toolchain.application.comparison import build_what_if_diff
