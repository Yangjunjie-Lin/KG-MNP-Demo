...
def compare_evidence(
    ...
    for key in sorted(set(left) & set(right)):
        ...
        for field in sorted(fields):
            ...
            if av != bv and (field in a or field in b) and (
                field in _EVIDENCE_COMPARE_FIELDS or (field in a and field in b)
            ):
                # Report meaningful compare fields or fields present on both sides.
