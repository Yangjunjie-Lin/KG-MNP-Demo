...
from zhigou_toolchain.integrations.object_query import query_objects
from zhigou_toolchain.integrations.oms import OMSMetadataService
from zhigou_toolchain.lifecycle.changes import (
    attach_candidate_package,
    create_change_proposal,
    evaluate_change,
    submit_change_proposal,
)
from zhigou_toolchain.lifecycle.contracts import verify
from zhigou_toolchain.lifecycle.diff.engine import create_diff
from zhigou_toolchain.lifecycle.diff.versioning import check_version
from zhigou_toolchain.lifecycle.environment import (
...
from zhigou_toolchain.lifecycle.errors import LifecycleError
from zhigou_toolchain.lifecycle.guards import (
    package_files,
    package_record,
    record_by_id,
)
from zhigou_toolchain.lifecycle.impact import analyze_impact
from zhigou_toolchain.lifecycle.policy import load_policy
from zhigou_toolchain.lifecycle.registry.head import read_head
from zhigou_toolchain.lifecycle.registry.import_package import import_package
from zhigou_toolchain.lifecycle.registry.manifest import load_manifest
from zhigou_toolchain.lifecycle.registry.replay import verify_registry
from zhigou_toolchain.lifecycle.regression import (
    declared_consumer_tests,
    plan_regression,
    require_consumer_coverage,
    run_regression,
)
from zhigou_toolchain.lifecycle.release import (
    _quorum,
    attest_release,
...
from zhigou_toolchain.lifecycle.store import list_records, save
...
def _diff(root,identifier):
    from zhigou_toolchain.lifecycle.diff.engine import verify_diff
...
def execute(app, project, request, principal):
    ...
    try:
        if name=="feedback.add":
            from zhigou_toolchain.lifecycle.feedback import add_feedback
        ...
        if name=="consumer.register":
            ...
            from zhigou_toolchain.lifecycle.consumer import register_consumer
        ...
        if name=="object.trace":
            ...
            from zhigou_toolchain.semantic_kernel.artifact_resolver import (
