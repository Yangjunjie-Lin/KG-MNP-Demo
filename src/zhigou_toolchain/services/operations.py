...
def build_operation_catalog() -> dict[str, OperationDefinition]:
    definitions: list[OperationDefinition] = [
        ...
        OperationDefinition("modeling.evolution.review", "TrajectoryReviewRequest", "TrajectoryReview", ("source:read", "trace:review"), True, "JOB", "WRITE", "REQUIRED"),
        ...
        OperationDefinition("task.execute", "TaskExecuteRequest", "ActionReceipt", ("task:execute", "action:work-order:create", "package:read", "source:read"), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("business.inspect", "EmptyRequest", "BusinessState", ("task:read", "source:read"), True),
        OperationDefinition("evolution.propose", "EvolutionProposalRequest", "EvolutionCandidate", ("model:propose", "task:read", "source:read"), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("evolution.evaluate", "EvolutionCandidateRequest", "EvolutionEvaluation", ("model:propose", "task:read", "source:read"), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("evolution.review", "EvolutionReviewRequest", "EvolutionReview", ("evolution:review", "task:read", "source:read"), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("evolution.activate", "EvolutionCandidateRequest", "EvolutionReceipt", ("evolution:activate", "task:read", "source:read"), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("evolution.rollback", "EvolutionRollbackRequest", "EvolutionReceipt", ("evolution:rollback",), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("modeling.session.open", "ModelingSessionRequest", "ModelingSession", ("model:propose", "source:read"), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("modeling.session.revise", "ModelingSessionRevisionRequest", "ModelingSession", ("model:propose",), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("modeling.semantic.check", "SemanticCheckRequest", "FiveStageRunV1", ("model:propose", "source:read"), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("modeling.tutorial.seed", "EmptyRequest", "FiveStageRunV1", ("project:write", "source:write", "source:read", "model:propose"), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("compile.plan.exact", "CompileExactPlanRequest", "CompilationPlan", ("compile:run",), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("modeling.profile", "ModelingProfileRequest", "FiveStageRunV1", ("model:propose", "source:read"), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("modeling.scope.draft", "ModelingScopeDraftRequest", "FiveStageRunV1", ("model:propose", "source:read"), True, "JOB", "WRITE", "REQUIRED"),
        OperationDefinition("modeling.methods", "EmptyRequest", "MethodRegistryV1", _READ),
        OperationDefinition("modeling.tutorial", "EmptyRequest", "TutorialReferenceV1", _READ),
...
HANDLERS = {
    ...
    "modeling.evolution.review": "zhigou_toolchain.services.handoff.execute",
    ...
    "business.inspect": "kg_mnp.services.business.execute", "evolution.propose": "kg_mnp.services.business.execute",
    "evolution.evaluate": "kg_mnp.services.business.execute", "evolution.review": "kg_mnp.services.business.execute",
    "evolution.activate": "kg_mnp.services.business.execute", "evolution.rollback": "kg_mnp.services.business.execute",
    "modeling.session.open": "kg_mnp.services.modeling_sessions.execute",
    "modeling.session.revise": "kg_mnp.services.modeling_sessions.execute",
    "modeling.methods": "kg_mnp.modeling.five_stage.registry.registry",
    "modeling.tutorial": "kg_mnp.modeling.five_stage.registry.tutorial",
