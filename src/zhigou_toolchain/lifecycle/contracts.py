...
from zhigou_toolchain.contracts.registry import get_contract_schema, validate_contract
from zhigou_toolchain.semantic_kernel.security import (
    assert_safe_json,
...
def contract_for(value: dict[str, Any]) -> str:
    ...
    from zhigou_toolchain.contracts.registry import load_contract_registry
    hits = []
