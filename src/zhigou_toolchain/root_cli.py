...
_ROOT_HELP = """usage: zhigou-toolchain <command> [options]
...
Run `zhigou-toolchain <command> --help` for command-specific help.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if arguments and arguments[0] in {"application","workbench","diagnostics","governance","amendment","activation",
        ...
        print("CLI_RETIRED: use zhigou-toolchain service serve and authenticated model/review/lifecycle resources")
        return 2
