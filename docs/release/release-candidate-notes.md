...
Linux 后续固定 dfcfa8c 的快照/对象/归档/撤销/历史包子集15通过、0跳过。增量证据包 runtime_logs/p09/checkpoint-evidence-20260908.zip 已生成并通过 ZIP CRC 检查，4,286,279 字节，SHA256 为 6c21f1d3318f55bddf83658daeedd402f25fdf54b2d39b575ef070ba9dc58a8a。它包含原始失败和复验、真实浏览器截图及输出包，排除运行 Workspace/凭证存储；不是最终同修订验收或发行候选安装包。
