...
export const ontologyViewFixture = {
  modules: [{ module: "CORE", label_zh: "核心本体", description: "核心概念" }],
  graph: {
    nodes: [
      { id: "urn:mnp:case", local_name: "MNPCase", label: "携转案例", type: "Class", module: "CORE" },
      { id: "urn:mnp:assessment", local_name: "EligibilityAssessment", label: "资格评估", type: "Class", module: "CORE" },
    ],
    edges: [
      { source: "urn:mnp:case", target: "urn:mnp:assessment", predicate: "hasAssessment" },
    ],
  },
  key_paths: [
    {
      ...
      predicate: "hasAssessment",
      target_class: "EligibilityAssessment",
      exists_in_rdf: true,
    },
  ],
  stats: { class_count: 2, edge_count: 1 },
};

export const ontologyPropertiesFixture = {
  object_properties: [
    { local_name: "hasAssessment", label_zh: "关联评估" },
  ],
  data_properties: [],
};
