...
export const ontologyClassLabels: Record<string, string> = {
  ...
  TelecomService: "电信业务",
  NaturalPerson: "自然人订户",
  OrganisationSubscriber: "组织订户",
  RealNameRegistration: "实名登记",
  IdentityVerification: "身份核验",
  PhoneNumberOwnership: "号码归属",
  BillingAccount: "计费账户",
  Bill: "账单",
  Charge: "费用项",
  Payment: "缴费记录",
  OutstandingBalanceObservation: "欠费观测",
  PaymentArrangement: "缴费安排",
  BillingSettlement: "账单结清",
  MobilePlan: "移动套餐",
  BroadbandService: "宽带业务",
  ValueAddedService: "增值业务",
  SupplementaryCardService: "副卡业务",
  ConvergedService: "融合业务",
  CommitmentPeriod: "承诺期",
  TerminationAgreement: "解除协议",
  MNPRequest: "携转申请",
  EligibilityCheck: "资格检查步骤",
  AuthorizationCodeRequest: "授权码申请",
  PortInSubmission: "携入提交",
  PortingExecution: "携转执行",
  PortingConfirmation: "携转确认",
  ProcessEvent: "流程事件",
  MNPCaseStatus: "案件状态",
  ReassessmentMarker: "重评标记",
  CodeListEntry: "码表项",
  APIResponse: "接口响应证据",
  EvidenceValidity: "证据有效性",
  ObservationTime: "观测时间",
  EvaluationTime: "评估时间点",
  RecordedTime: "记录时间点",
};
...
export const ui = {
  ...
  empty: "暂无数据",
  loading: "加载中…",
  searchOntology: "搜索本体概念…",
  ontologyOverviewRelations: "总览展示关系",
  ontologyCollapsedRelations: "已折叠次级关系",
  ontologyUnmappedConcepts: "未映射概念",
  ontologyTechnicalAdjacency: "技术节点关联归层",
  ontologyTechnicalFallback: "技术节点回退归层",
  ontologyLayoutCheckFound: "布局检查发现",
  ontologyLayoutCheckAnomalies: "项异常",
  ontologyBusinessLayer: "所属业务层",
  ontologyInOverview: "属于总览",
  ontologyOutgoingCount: "直接出边数量",
  ontologyIncomingCount: "直接入边数量",
  ontologyRelatedConcepts: "直接关联概念",
  ontologyRelationList: "完整关系列表",
  ontologyYes: "是",
  ontologyNo: "否",
  ontologySelectNodeHint: "点击图中节点查看本体类详情",
  ontologyViewNav: "本体视图",
  baseline: "基准方案",
  scenario: "推演方案",
